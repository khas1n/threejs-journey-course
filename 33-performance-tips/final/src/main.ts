...
for (let i = 0; i < 50; i++) {
  const position = new Vector3((Math.random() - 0.5) * 10, (Math.random() - 0.5) * 10, (Math.random() - 0.5) * 10)

  const quaternion = new Quaternion()
  quaternion.setFromEuler(new Euler((Math.random() - 0.5) * Math.PI * 2, (Math.random() - 0.5) * Math.PI * 2, 0))
